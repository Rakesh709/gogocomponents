...
function Homepage() {
  return (
    <div className="max-w-full">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-32 text-center">
          ...
          <div className="mt-12 flex justify-center gap-6 flex-wrap">
            ...
            <div className="bg-[#fbfbfb] text-black border px-4 py-4 rounded-full shadow-md transform hover:scale-105 transition">
              nothing else
            </div>
      ...
      {/* 👇 Outlet will render nested pages like /components, /docs, etc */}
      <Outlet />
